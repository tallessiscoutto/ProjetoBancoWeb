    ...
    <main class="main-content">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="stat-info">
                    <h3><?php echo e($stats['produtos']); ?></h3>
            ...
            <div class="stat-card">
                ...
                <div class="stat-info">
                    <h3><?php echo e($stats['clientes']); ?></h3>
                    <p>Clientes</p>
                </div>
            </div>
            <div class="stat-card">
                ...
                <div class="stat-info">
                    <h3><?php echo e($stats['funcionarios']); ?></h3>
                    <p>Funcionários</p>
                </div>
            </div>
            <div class="stat-card">
                ...
                <div class="stat-info">
                    <h3><?php echo e($stats['vendas_hoje']); ?></h3>
                    <p>Vendas Hoje</p>
                </div>
            </div>
            <div class="stat-card">
                ...
                <div class="stat-info">
                    <h3><?php echo e($stats['produtos_estoque_baixo']); ?></h3>
                    <p>Estoque Baixo</p>
                </div>
            </div>
            <div class="stat-card">
                ...
                <div class="stat-info">
                    <h3><?php echo e($stats['reservas_ativas']); ?></h3>
                    <p>Reservas Ativas</p>
                </div>
            </div>
        </div>
