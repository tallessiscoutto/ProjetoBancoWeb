                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <form method="POST" action="<?php echo e(route('Reservas.concluir', $r->id)); ?>">
                                            <?php echo csrf_field(); ?>
                                            <button type="submit" class="btn btn-sm btn-success" <?php echo e($r->status!=='ativa' ? 'disabled' : ''); ?>>
                                                <i class="fas fa-check"></i>
                                            </button>
                                        </form>
                                        <form method="POST" action="<?php echo e(route('Reservas.cancelar', $r->id)); ?>" class="ms-2">
                                            <?php echo csrf_field(); ?>
                                            <button type="submit" class="btn btn-sm btn-danger" <?php echo e($r->status!=='ativa' ? 'disabled' : ''); ?>>
